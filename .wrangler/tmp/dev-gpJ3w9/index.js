  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/api/notes" && request.method === "GET") {
      ...
      if (recordId) {
        ...
        return Response.json(result2.results ?? []);
      }
    ...
    if (url.pathname === "/api/notes" && request.method === "POST") {
      ...
      ).bind(body.record_id, body.author, body.content).run();
      return Response.json(
        {
          success: true,
...
// .wrangler/tmp/bundle-pINSPW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pINSPW/middleware-loader.entry.ts
